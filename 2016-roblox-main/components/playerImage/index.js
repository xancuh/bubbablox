...
const PlayerImage = (props) => {
  ...
  const [image, setImage] = useState(props.url ? props.url : 
    props.useHeadshot 
      ? thumbs.getUserHeadshot(props.id, '420x420') 
      : thumbs.getUserThumbnail(props.id, '420x420'));
